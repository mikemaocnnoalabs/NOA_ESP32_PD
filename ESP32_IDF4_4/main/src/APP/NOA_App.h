...
#define  APP_MSG_POWERSAVE            MSG_ID_USER_APP_START+0xFAD
#define  APP_MSG_WAKEUP               MSG_ID_USER_APP_START+0xFAE
#define  APP_MSG_KEYCLICK             MSG_ID_USER_APP_START+0xFAF
