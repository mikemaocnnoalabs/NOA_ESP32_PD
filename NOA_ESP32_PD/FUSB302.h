...
int     fusb302_tcpm_release(int port);
...
int     fusb302_tcpm_get_message(int port, uint32_t *payload, int *head);
int     fusb302_tcpm_send_message(int port, uint16_t header, const uint32_t *data, uint8_t *buf, int buf_pos);
...
int     fusb302_convert_bc_lvl(int port, int bc_lvl);
void    fusb302_detect_cc_pin_source_manual(int port, int *cc1_lvl, int *cc2_lvl);
int     fusb302_measure_cc_pin_source(int port, int cc_measure);
void    fusb302_detect_cc_pin_sink(int port, int *cc1, int *cc2);
...
// int     fusb302_tcpc_xfer(const uint8_t *out,  int out_size, uint8_t *in, int in_size, int flags); */
